...
const SAMPLE_COMMENTS: Comment[] = [
  ...
  },
  {
    ...
    userAvatar: "SW",
    content:
      "I agree. The neighborhood is up and coming with new developments.",
...
export default function CollaborationHub({
  ...
  const [activeTab, setActiveTab] = useState<"comments" | "team" | "activity">(
    "comments",
  );
      ...
      <div className="flex-1 overflow-auto">
        ...
        {activeTab === "comments" && (
          <div className="p-4">
            {/* Property Filter */}
            <div className="mb-4">
              <label className="text-xs text-dark-500 block mb-2">
                Filter by Property
              </label>
              <select
            ...
            <div className="relative">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    user: "John Smith",
                    action: "changed strategy to BRRR",
                    target: "654 Maple Dr",
                    time: "3 hours ago",
                  },
                ].map((activity, index) => (
